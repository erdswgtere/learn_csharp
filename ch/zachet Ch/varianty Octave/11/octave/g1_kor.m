%% этот файл нужен чтобы показать промежуток где есть корни + в командном окне выводится уточнённое значение корня
x = -10:1:10;
...
[X, Y] = fzero('f1', 4.7); %% заменить 4.7 на свой корень
X
